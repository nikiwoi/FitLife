...
public class InitializeLatihan {
    public void inisialisasiLatihan() {
        ...
        // Beginner
        // --- WARM UP ---
        beginner.addLatihan(new DurationLatihan("Arm Circles", "Stand straight, extend arms, make small circles",
                "Shoulder Mobility, WarmUp", "WarmUp", 1, 30));
        beginner.addLatihan(new RepetitionLatihan("Jumping Jacks",
                "Jump with legs spread and hands overhead, then return", "Cardio, WarmUp", "WarmUp", 1, 20));
        ...
        beginner.addLatihan(new RepetitionLatihan("Squat", "Stand with feet shoulder-width, lower hips, return up",
        ...
        beginner.addLatihan(
                new RepetitionLatihan("Glute Bridge", "Lie on your back, lift hips upward, squeeze glutes, lower down",
        ...
        beginner.addLatihan(new RepetitionLatihan("Standing Calf Raise",
                "Stand and lift heels off the ground, then lower", "Calf Strength, Balance", "MainWorkout", 2, 15));
        beginner.addLatihan(new RepetitionLatihan("Step Up", "Step onto a low platform, alternate legs", "Leg Strength",
                "MainWorkout", 2, 12));
        ...
        intermediate.addLatihan(new RepetitionLatihan("Squat Jump", "Squat then jump explosively", "Leg Power, Cardio",
                "MainWorkout", 4, 15));
        ...
        intermediate.addLatihan(new RepetitionLatihan("Reverse Lunge", "Step backward into a lunge, alternate legs",
        ...
        intermediate.addLatihan(new DurationLatihan("Superman", "Lie face down, lift arms and legs", "Back Strength",
                "MainWorkout", 2, 30));
        ...
        advanced.addLatihan(new DurationLatihan("Jump Rope Double Under", "Jump rope, rope passes twice per jump",
                "Cardio, WarmUp", "WarmUp", 2, 30));
